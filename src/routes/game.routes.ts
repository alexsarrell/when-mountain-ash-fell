...
import {RACES, CLASSES, STARTING_ITEMS, STAT_DEFINITIONS} from '../data/game.content'

const router = Router()

router.get('/content', (req, res) => {
  res.json({ races: RACES, classes: CLASSES, items: STARTING_ITEMS, stats: STAT_DEFINITIONS })
})
